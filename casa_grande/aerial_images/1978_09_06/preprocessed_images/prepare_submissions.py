...
globstr = 'ARBC*.tif' # need to fill in with image matching pattern
crs = 6341 # need to fill in with epsg code
pitch = 0.025 # need to fill in with pixel pitch of images
