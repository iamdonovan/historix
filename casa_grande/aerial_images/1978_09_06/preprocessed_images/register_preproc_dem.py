...
landmask = Path('..', '..', '..', 'aux_dems', f"{prefix}_reference_dem_zoom_mask.tif") # fill in path to optional land mask
fn_ref = Path('..', '..', '..', 'aux_dems', f"{prefix}_reference_dem_zoom.tif") # fill in path to dem
