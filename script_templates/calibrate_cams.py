...
globstr = 'DZB*.tif'
tapioca_res = -1 # have to fill in with maximum res for tapioca mulscale.
focal = 0 # fill in with focal length (in mm) from calibration report / intrinsics
camname = '' # fill in with camera name from convert_gpcs.py
